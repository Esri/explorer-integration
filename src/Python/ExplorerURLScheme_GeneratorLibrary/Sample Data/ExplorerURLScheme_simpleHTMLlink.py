...
explicitURL = 'arcgis-explorer://?id=2adf08a4a1a84834a773805a6e86f69e'
title = "simple_openMap"

'''3) Call to libraries -- Generate single link pages from data above'''
explorerURLObject = ExplorerURLScheme(parameterDictionary)  # create NavigatorURLScheme object and generateURL
explicitURL = explorerURLObject.generateURL() if generateURL == True else explicitURL   # based on above setting, build or use explicit url
